...
urlpatterns = [
    ...
    path('get-bar-chart-data-week', views.get_bar_chart_data_week, name='get_bar_chart_data_week'),
    path('get-bar-chart-data-month', views.get_bar_chart_data_month, name='get_bar_chart_data_month'),
    path('get-bar-chart-data-year', views.get_bar_chart_data_year, name='get_bar_chart_data_year'),
