...
class RoomTopView(LoginRequiredMixin, generic.TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['follower_room_list'] = Room.objects.select_related().filter(publication='follower')
        context['public_room_list'] = Room.objects.select_related().filter(publication='public')
        return context
